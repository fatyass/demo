...
',
  ...
  array (
    ...
    'Thank you! You will receive an email with your affiliate token as soon as your account will be activated.' => 'Thank you! You will receive an email with your affiliate token as soon as your account will be activated.',
    'Become an Affiliate' => 'Become an Affiliate',
    'Create' => 'Create',
    'Jobs in the %category% category' => 'Jobs in the %category% category',
    ...
    ']-Inf,0] Expired|{1}Expires in 1 day|]1,Inf[ Expires in %days% days' => ']-Inf,0] Expired|{1}Expires in 1 day|]1,Inf[ Expires in %days% days',
    '[Bookmark this <a href="%url%">URL</a> to manage this job in the future]' => '[Bookmark this <a href="%url%">URL</a> to manage this job in the future]',
  ),
));
